                                    ...
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <%for(Transaction a:transactionList){ %>
                                            <tr>
												...
												<td>Not Active</td>
												<%} %>                                           	
                                            	<td><a data-toggle="modal" data-target="#exampleModalCenter" onclick="getid(<%=a.getTransactionId()%>);"><i class="fa fa-trash" aria-hidden="true" style="color: red; cursor: pointer; font-size: 25px;"></i></a></td>
                                           </tr>
                                            <%} %>
